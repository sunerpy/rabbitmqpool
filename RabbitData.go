...
type RabbitMqData struct {
	...
	Route        string //路由
	Data         string //发送数据
	Localfile    string //本地文件用于保存发送失败的数据
}
...
*/
func GetRabbitMqDataFormat(exChangeName string, exChangeType string, queueName string, route string, data string, localFile string) *RabbitMqData {
	return &RabbitMqData{
